...
│   ├── categoryBank.js   "Can You Pass As..." — 115 built-in categories (14
│   │                     sections × ~3-35 categories, 8 Qs each, 920 total).
...
Built-in categories live in `core/categoryBank.js` as `SECTIONS` (14 sections,
grouping 115 "Can You Pass as..." categories, 8 questions each — 920 total).
